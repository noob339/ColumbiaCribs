...
function ReviewPage() {
    ...
    const slug = params.get("building");

    const buildingFromState = location.state?.building || null;
    const buildingFromSlug = slug
    ...
    const building =
        buildingFromState ||
        buildingFromSlug ||
        buildings.find((b) => b.slug === "broadway-hall") ||
        buildings[0];
    ...
    return (
        <main className='review-page'>
            <section className='review-card-page'>
                ...
                {/* RIGHT: building + ratings  We should stack them, this isn't very humane centered but in the future!*/}
                <div className='review-right'>
                    <div className='building-card'>
                        <h3 className='building-name'>{buildingTitle}</h3>
